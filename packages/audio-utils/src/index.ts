...
export { DEFAULTS, SIMPLE_DEFAULTS, expandParams } from "./types";
export type { ProcessingParams, SimpleParams, EQBand } from "./types";
export { detectFirstTransient } from "./transient-detector";
